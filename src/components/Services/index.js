  ...
  return (
    <section className='container l-sections'>
      <div className='services l-container'>
        ...
        <p>
          Aqui puedes ver los servicios que ofrezco. Si tienes alguna pregunta,
        ...
        <div className='services-container'>
          <div className='services-container__item'>
            ...
            <p>
              Diseño enfocado en la usabilidad y experencia de usuario, para
              hacer del proyecto muy intuitivo.
            </p>
          </div>
          <div className='services-container__item'>
          ...
          <div className='services-container__item'>
            ...
            <p>
              Diseño totalmente adaptable a cualquier dispositivo, mobil, tablet
              y de escritorio.
            </p>
          </div>
          <div className='services-container__item'>
            ...
            <p>
              Codigo enfocado para poder pocicionarse en los motores de
              busquedas y tener mas alcance.
            </p>
          </div>
          <div className='services-container__item'>
